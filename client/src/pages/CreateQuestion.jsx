...
const CreateQuestion = () => {
    ...
    //-- Get lesson from DB, depending on course.
    useEffect(() => {
        ...
        async function fetchLessons() {
            ...
            await fetch(url).then(res => res.json()).then((data) => {
                setLessons(data.filter((da) => da.course_id == course_id))
            })
        }
    ...
    const save = async (e) => {
        ...
        const data = {course_id, lesson_id, stem, answer, alt1, alt2, alt3, alt4, status}
